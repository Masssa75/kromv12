-- Create cron job for token discovery analyzer (every 10 minutes)
-- This will analyze any backlog of tokens with websites
SELECT cron.schedule(
  'token-discovery-analyzer-every-10-min',
  '*/10 * * * *',
  $$
  SELECT net.http_post(
    url:='https://eucfoommxxvqmmwdbkdv.supabase.co/functions/v1/token-discovery-analyzer',
