...
# Configuration
BATCH_SIZE = 50  # Increased back for faster processing
...
def process_batch(batch_number, offset):
    ...
    try:
        ...
        for i, token in enumerate(tokens):
            ...
            # Skip delay for KROM prices and no-pool tokens
...
while batch_number <= 20:  # Process 20 batches = 1000 tokens with new batch size
