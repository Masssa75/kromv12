...
serve(async (req) => {
  try {
    ...
    console.log('Premium bot?', isPremium)
    ...
    if (update.message && update.message.text) {
      ...
      // Handle /groupid command (also handle with bot username)
      if (text === '/groupid' || text.startsWith('/groupid@') || text.toLowerCase() === '/groupid' || text.toLowerCase().startsWith('/groupid@')) {
